    ...
    <>
      <motion.header
        ...
        style={{
          ...
          transition: "background-color 200ms cubic-bezier(0.4, 0, 0.2, 1), border-bottom-color 200ms cubic-bezier(0.4, 0, 0.2, 1), box-shadow 200ms cubic-bezier(0.4, 0, 0.2, 1)",
        }}
        initial={{ y: -100 }}
        animate={{ y: 0 }}
          ...
          <div className="flex items-center justify-center flex-shrink-0">
            ...
            >
              <span className="relative inline-block">
                <span
                  className="font-serif text-xl sm:text-2xl md:text-3xl font-bold whitespace-nowrap block"
                  style={{
